...
بهذا اكتملت بوابة قاعدة البيانات للمرحلة 2B على Staging. الخطوة التالية هي بناء واجهة سجل المعالجات ومسار إعداد/مراجعة/اعتماد المسودة فوق هذه الدوال، مع إبقاء زر التنفيذ الفعلي محجوبًا حتى المرحلة 2C.
