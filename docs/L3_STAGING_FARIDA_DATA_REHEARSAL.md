...
> التاريخ: 2026-09-08
> الحالة: اكتملت النسخ الاحتياطية وحزمة التنفيذ واختبار التقديم والاسترجاع المعزول؛ لم تتغير Staging
...
الخطة التنفيذية المفصلة في `docs/L3_STAGING_RESTORE_RUNBOOK.md`. الخطوة التالية هي تجربة ملف SQL صغير آمن على Staging عبر المسار الفعلي نفسه، يبدأ بمعاملة وينتهي بـ`ROLLBACK`، ثم التحقق من عدم بقاء أي أثر. لا ينفذ ملف التقديم الحقيقي قبل عرض النتيجة والحصول على اعتماد صريح.
