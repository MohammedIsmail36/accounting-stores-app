...
const InventoryReconciliationRepairsPage = lazy(() => import("./pages/reports/InventoryReconciliationRepairsPage"));
const InventoryReconciliationRepairDetailPage = lazy(() => import("./pages/reports/InventoryReconciliationRepairDetailPage"));
      ...
      <ErrorBoundary>
        ...
        >
          <AuthProvider>
            ...
            <Route path="/reports/inventory-reconciliation/repairs" element={<ProtectedRoute allowedRoles={["admin", "accountant"]}><AppLayout>{withSuspense(<InventoryReconciliationRepairsPage />)}</AppLayout></ProtectedRoute>} />
            <Route path="/reports/inventory-reconciliation/repairs/:id" element={<ProtectedRoute allowedRoles={["admin", "accountant"]}><AppLayout>{withSuspense(<InventoryReconciliationRepairDetailPage />)}</AppLayout></ProtectedRoute>} />
