...
> التاريخ: 2026-09-08
> الحالة: اكتملت النسخ الاحتياطية والفحص المسبق وحزمة النقل؛ لم تبدأ الاستعادة
...
أُعدت خطة التنفيذ في `docs/L3_STAGING_RESTORE_RUNBOOK.md`. الخطوة التالية هي إنشاء ملفي forward وrollback بصيغة قابلة لـ`db query` وفحصهما دون تنفيذ. لا تبدأ الاستعادة قبل اكتمال الملفين وتجربة معاملة صغيرة تنتهي بـ`ROLLBACK`.
